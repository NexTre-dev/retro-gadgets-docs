...
Draws **an entire sprite sheet** mapping it on a quad identified by position1, position2, position3, and position4. The locations of the `position1`, `position2`, `position3` and `position4` are in the top-left, top-right, bottom-right and bottom-left respectively. 
